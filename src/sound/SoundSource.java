...
//    URL url = getClass().getResource("C:/Users/Walber Rodrigues/git/OpenAL/SoundMaze/s.wav");
//    System.out.println("defaultSound " + defaultSound);  // check the URL!
//    AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(defaultSound);
    
//    WaveData waveFile = WaveData.create();
    WaveData waveFile = WaveData.create(new BufferedInputStream(new FileInputStream("C:/Users/Walber Rodrigues/git/OpenAL/SoundMaze/s.wav")));
