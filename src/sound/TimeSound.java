...
public class TimeSound implements Runnable {
	private float obj_x;
	private float obj_y;
	private float obj_z;
...
//	private boolean jogando;
	...
	private int qtdAproximar;
	private Float volume;
	
	private Fase3 fase;
	
	public TimeSound(Float obj_x, Float obj_y, Float obj_z, FloatBuffer listenerPosA, FloatBuffer listenerVelA, FloatBuffer listenerOriA, String arquivo, int intervalo, int qtdAproximar, Float volume, Fase3 fase/*Ponto bonecao*/){
		this.obj_x = obj_x;
		this.obj_y = obj_y;
		this.obj_z = obj_z;
		//this.boneco = bonecao;
		...
		this.qtdAproximar = qtdAproximar;
		this.volume = volume;
		
		this.fase = fase;
	}
	
	public TimeSound(Float obj_x, Float obj_y, Float obj_z, FloatBuffer listenerPosA, FloatBuffer listenerVelA, FloatBuffer listenerOriA, /*String arquivo,*/ int intervalo, Float volume/*Ponto bonecao*/){
		this.obj_x = obj_x;
		this.obj_y = obj_y;
		this.obj_z = obj_z;
		//this.boneco = bonecao;
	...
	public void run(){
		...
		while(jogando){
			...
			try {
				...
				contador++;
				if(contador == this.qtdAproximar){
					contador = 0;
					this.obj_x = this.obj_x + 1;
					System.out.println("Obj_x = " + this.obj_x);
				}
				if(this.obj_x == 0.0f){
					System.out.println("Morreu");
					this.fase.setGanhou(false);
					this.jogando = false;
				}
				if(this.obj_x > -1.0f){
